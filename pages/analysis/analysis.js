...
Page({
  ...
  data: {
    ...
    allsubjects: [
      // {name: '总分', passNum: 0, passRate: 70},
      // {name: '语文', passNum: 0, passRate: 70},
      // {name: '数学', passNum: 0, passRate: 100},
      // {name: '英语', passNum: 0, passRate: 0},
      // {name: '物理', passNum: 0, passRate: 0},
      // {name: '化学', passNum: 0, passRate: 0},
      // {name: '生物', passNum: 0, passRate: 0},
      // {name: '理综', passNum: 0, passRate: 0},
    ],
    thisExamData: [
      // {name: '总分', riseNumB: -1, riseNumD: 10, passflag: false},
      // {name: '语文', riseNumB: -1, riseNumD: 10, passflag: false},
      // {name: '数学', riseNumB: -5, riseNumD: 20, passflag: true},
      // {name: '英语', riseNumB: -7, riseNumD: 30, passflag: false},
      // {name: '物理', riseNumB: -8, riseNumD: 50, passflag: true},
      // {name: '化学', riseNumB: 0, riseNumD: 0, passflag: true},
      // {name: '生物', riseNumB: 0, riseNumD: 0, passflag: true},
      // {name: '理综', riseNumB: '-', riseNumD: '-', passflag: true},
    ],
    ec: {
      // onInit: initChart
      lazyLoad: true
  ...
  studentgogogo: function (e) {
    console.log("studengogogo")
    wx.navigateTo({ url: '/pages/teacheranalysis/teacheranalysis?id=0' })
  },

  classgogogo: function (e) {
    console.log("classgogogo")
    wx.navigateTo({ url: '/pages/teacheranalysis/teacheranalysis?id=1' })
  },
  gradegogogo: function (e) {
    console.log("gradegogogo")
    wx.navigateTo({ url: '/pages/teacheranalysis/teacheranalysis?id=2' })
  },
  ...
  submitdata: function (e) {
    ...
    wx.request({
      url: `https://cityinthesky.top/dataanalysis?stuname=${that.data.stuname}&classname=${that.data.classarray[1][that.data.classindex[1]]}&schoolname=${that.data.schoolarray[that.data.schoolindex]}&userid=${that.data.userid}&role=${that.data.role}`,
